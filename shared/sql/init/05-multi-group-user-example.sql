-- Multi-Group User Example
-- This script creates a user who belongs to multiple groups with different roles
-- Example: A developer who also works in customer support
...
INSERT INTO core.users (
    ...
    'John',
    'Developer',
    'MARKETPLACE_DEVELOPER', -- Primary role
    'active',
...
-- Create another multi-role user (HR Manager who also develops)
INSERT INTO core.users (
    id,
    tenant_id,
    email,
...
-- Get the user IDs and group IDs for assignment
WITH user_ids AS (
    SELECT 
        u.id as user_id,
        u.email,
...
-- Show the combined permissions for each user
SELECT 
    u.email,
    u.first_name,
    u.last_name,
