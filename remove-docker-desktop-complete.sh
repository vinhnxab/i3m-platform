...
# Complete Docker Desktop Removal Script
# Loại bỏ hoàn toàn Docker Desktop và cài đặt Docker Engine
...
print_header "Complete Docker Desktop Removal"
echo "====================================="
...
# Remove Docker Desktop from shell profiles
