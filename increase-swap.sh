...
# Script to increase swap from 4GB to 8GB
echo "=== I3M Platform Swap Increase Script ==="
...
echo "=== Step 4: Create new 8GB swap file ==="
sudo fallocate -l 8G /swap.img
echo "New 8GB swap file created"
echo
...
echo "Swap increased from 4GB to 8GB successfully!"
echo "System will now have more virtual memory available."
